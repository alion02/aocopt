...
unsafe fn inner2(s: &[u8]) -> u32 {
    ...
    "300:",
        ...
        "vpaddw {adjdist}, {vecdist}, {cached1}",
        "vpcmpgtw {cutsw}, {adjdist}, [{ptr} + {off23}]",
        ...
        "vpaddw {cutsw}, {cutsw}, {tmp}",
        "vpaddw {adjdist}, {vecdist}, {cached2}",
    ...
    "20:",
        ...
        cached1 = in(ymm_reg) PENALTIES[INDICES[22] / 32],
        cached2 = in(ymm_reg) PENALTIES[INDICES[0] / 32],
        cached3 = in(ymm_reg) PENALTIES[INDICES[1] / 32],
        cached4 = in(ymm_reg) PENALTIES[INDICES[2] / 32],
        cached5 = in(ymm_reg) PENALTIES[INDICES[3] / 32],
        cached6 = in(ymm_reg) PENALTIES[INDICES[4] / 32],
        cached7 = in(ymm_reg) PENALTIES[INDICES[5] / 32],
        cached8 = in(ymm_reg) PENALTIES[INDICES[6] / 32],
        cached9 = in(ymm_reg) PENALTIES[INDICES[7] / 32],
        cached10 = in(ymm_reg) PENALTIES[INDICES[8] / 32],
    );
